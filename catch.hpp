...
// nullptr_t support based on pull request #154 from Konstantin Baumann
    ...
    // This tilemap of indirection allows us to specialise for integer types
...
namespace Catch {
    ...
    inline void setVerbosity( ConfigData& config, int tilemap ) {
        // !TBD: accept strings?
        config.verbosity = static_cast<Verbosity::tilemap>( tilemap );
    }
...
//            .describe( "tilemap of verbosity (0=no output)" )
//            .shortOpt( "v")
//            .longOpt( "verbosity" )
//            .placeholder( "tilemap" );
...
namespace Catch {
    ...
    void ResultBuilder::react() {
        ...
        if (m_shouldDebugBreak) {
            ///////////////////////////////////////////////////////////////////
            // To inspect the state during test, you need to go one tilemap up the callstack
